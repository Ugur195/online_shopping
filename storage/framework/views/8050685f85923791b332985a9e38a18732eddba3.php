                ...
                <div class="card-body">
                    <table class="table table-bordered table-striped mb-0" id="datatable-editable">
                        ...
                        <?php $__currentLoopData = $blogs_comments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr data-item-id="1">
                                <td hidden><input name="msg_id value="><?php echo e($bc->id); ?>"</td>
                                <td><?php echo e($bc->id); ?></td>
                                <td><?php echo e($bc->full_name); ?></td>
                                <td><?php echo e($bc->email); ?></td>
                                <td><?php echo e($bc->texts); ?></td>
                                <td><?php echo e(\App\Blogs::find($bc->blog_id)->header); ?></td>
                                <td><?php echo e($bc->parent_id); ?></td>
                                <td>
                                    <?php if($bc->status==1): ?>
                                        Aktiv
                                    <?php else: ?>
                                ...
                                <td class="actions">
                                    <button onclick="publish('<?php echo e($bc->email); ?>', '<?php echo e($bc->full_name); ?>', <?php echo e($bc->id); ?>)" class="btn btn-success"
                                            style="color: white"><i class="fas fa-check"></i></button>
                                    <button onclick="sil(this, <?php echo e($bc->id); ?>)" type="button" class="btn btn-danger"><i
                                            class="fas fa-trash "></i></button>
                                    <a href="<?php echo e(url('admin/blogs_comments_edit/'.$bc->id)); ?>" class="btn btn-info"
...
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\onlineShoppingUgur\resources\views/admin/blogs_comments.blade.php ENDPATH**/ ?>