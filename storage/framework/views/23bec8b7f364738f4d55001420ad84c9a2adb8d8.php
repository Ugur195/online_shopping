            ...
            <section class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="mb-3">
                                <a href="<?php echo e(url('admin/add_product')); ?>"  class="btn btn-success">Add <i class="fas fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                    <table class="table table-bordered table-striped mb-0" id="datatable-editable">
                        ...
                        <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr data-item-id="1">
                                ...
                                <td><?php echo e($p->real_price); ?></td>
                                <td><?php echo e($p->price); ?></td>
                                <td><?php echo e($p->discount_price); ?></td>
                                <td><?php echo e($p->count); ?></td>
                                <td><?php echo e($p->real_count); ?></td>
                                <td><?php echo e(\App\Brands::find($p->brand_id)->name); ?></td>
                                <td><?php echo e(\App\Categoryes::find($p->category_id)->name); ?></td>
                                <td><?php echo e($p->raitng); ?></td>
                                ...
                                <td class="actions">
                                    <a href="<?php echo e(url('admin/product_edit/'.$p->id)); ?>" class="btn btn-success" style="color: white"><i
                                            class="fas fa-pencil-alt"></i></a>
                                    <button onclick="sil(this, <?php echo e($p->id); ?>)" type="button" class="btn btn-danger"><i
...
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\onlineShoppingUgur\resources\views/admin/products.blade.php ENDPATH**/ ?>