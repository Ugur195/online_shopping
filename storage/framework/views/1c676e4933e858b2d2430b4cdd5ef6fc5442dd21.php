                ...
                <ul>
                    <?php $__currentLoopData = $slide; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="slide-overlay slide-overlay-primary" data-transition="fade">
                            <img src="data:image/jpeg;base64,<?php echo e(base64_encode($s->image)); ?>"
                                 alt=""
                            ...
                            <div class="tp-caption"
                                ...
                                <img src="<?php echo e(asset('frontendCss/img/slides/slide-title-border.png')); ?>"
                                     alt=""></div>
                            ...
                            <div class="tp-caption d-none d-md-block"
                                ...
                                <img src="<?php echo e(asset('frontendCss/img/slides/slide-white-line.png')); ?>" alt=""></div>
                            ...
                            <div class="tp-caption"
                                 ...
                                 data-transform_idle="opacity:0.2;s:500;"><img
                                    src="<?php echo e(asset('frontendCss/img/slides/slide-title-border.png')); ?>"
                                    alt=""></div>
                            ...
                            <h1 class="tp-caption font-weight-extra-bold text-color-light negative-ls-2"
                                ...
                                data-lineheight="['55','55','55','95']"><?php echo e($s->title); ?></h1>
                            ...
                            <div class="tp-caption text-light font-weight-light"
                                ...
                                <a type="button" class="btn btn-dark btn-with-arrow mb-2"
                                   href="<?php echo e($s->url); ?>">Etrafli<span>
                        ...
                        <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-12 col-sm-6 col-lg-3 product">
                                ...
                                <span class="product-thumb-info border-0">
									<a href="product/<?php echo e($p->id); ?>" class="add-to-cart-product bg-color-primary">
...
<?php echo $__env->make('frontend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\onlineShoppingUgur\resources\views/frontend/index.blade.php ENDPATH**/ ?>