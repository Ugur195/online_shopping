            ...
            <section class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="mb-3">
                                <a href="<?php echo e(url('admin/add_users')); ?>"  class="btn btn-success">Add <i class="fas fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                    <table class="table table-bordered table-striped mb-0" id="datatable-editable">
                        ...
                        <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr data-item-id="1">
                                <td><img style='display:block;width:80px;height:60px;'src="data:image/jpeg;base64,<?php echo e(base64_encode($u->image)); ?>"/></td>
                                <td><?php echo e($u->id); ?></td>
                                <td><?php echo e($u->name); ?></td>
                                <td><?php echo e($u->surname); ?></td>
                                <td><?php echo e($u->father_name); ?></td>
                                <td><?php echo e($u->mobile); ?></td>
                                <td><?php echo e($u->email); ?></td>
                                <td><?php echo e($u->address); ?></td>
                                <td><?php echo e(\App\Roles::find($u->role_id)->name); ?></td>
                                <td>
                                    <?php if($u->status==1): ?>
                                        Aktiv
                                    <?php else: ?>
                                ...
                                <td class="actions">
                                    <a href="<?php echo e(url('admin/user_edit/'.$u->id)); ?>" class="btn btn-success" style="color: white"><i
                                            class="fas fa-pencil-alt"></i></a>
                                    <button onclick="sil(this, <?php echo e($u->id); ?>)" type="button" class="btn btn-danger"><i
...
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\onlineShoppingUgur\resources\views/admin/users.blade.php ENDPATH**/ ?>