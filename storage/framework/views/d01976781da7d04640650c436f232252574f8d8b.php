            ...
            <section class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="mb-3">
                                <a href="<?php echo e(url('admin/add_blog_category')); ?>"  class="btn btn-success">Add <i class="fas fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                    <table class="table table-bordered table-striped mb-0" id="datatable-editable">
                        ...
                        <?php $__currentLoopData = $blog_category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr data-item-id="1">
                                ...
                                <td><?php echo e($bc->slug); ?></td>
                                <td><?php echo e($bc->created_at); ?></td>
                                <td><?php echo e($bc->updated_at); ?></td>
                                <td>
                                    <?php if($bc->status==1): ?>
                                        Aktiv
                                    <?php else: ?>
                                ...
                                <td class="actions">
                                    <a href="<?php echo e(url('admin/blog_category_edit/'.$bc->id)); ?>" class="btn btn-success" style="color: white"><i
...
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\onlineShoppingUgur\resources\views/admin/blog_category.blade.php ENDPATH**/ ?>