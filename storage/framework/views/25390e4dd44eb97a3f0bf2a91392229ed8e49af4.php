            ...
            <section class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="mb-3">
                                <a href="<?php echo e(url('admin/add_our_team')); ?>" class="btn btn-success">Add <i
                    ...
                    <table class="table table-bordered table-striped mb-0" id="datatable-editable">
                        ...
                        <tbody>
                        <?php $__currentLoopData = $our_team; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $o): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr data-item-id="1">
                                <td><img style='display:block;width:80px;height:60px;'
                                         src="data:image/jpeg;base64,<?php echo e(base64_encode(\App\User::find($o->user_id)->image)); ?>"/>
                                </td>
                                <td><?php echo e(\App\User::find($o->user_id)->name); ?></td>
                                <td><?php echo e(\App\User::find($o->user_id)->surname); ?></td>
                                <td><?php echo e(\App\User::find($o->user_id)->father_name); ?></td>
                                <td><?php echo e(\App\OurTeamRoles::find($o->our_team_role_id)->name); ?></td>
                                <td><?php echo e($o->description); ?></td>
                                <td>
                                    <a href="<?php echo e(url('admin/our_team_edit/'.$o->id)); ?>" class="btn btn-success"
                                       style="color: white"><i
                                            class="fas fa-pencil-alt"></i></a>
                                    <button onclick="sil(this, <?php echo e($o->id); ?>)" type="button" class="btn btn-danger"><i
...
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\onlineShoppingUgur\resources\views/admin/our_team.blade.php ENDPATH**/ ?>