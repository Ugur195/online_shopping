                ...
                <section class="card">
                    ...
                    <div class="card-body">
                        <form class="form-horizontal form-bordered" method="post"
                              action="<?php echo e(url('/admin/our_team_roles_edit/'. $our_team_roles->id)); ?>">
                            <?php echo e(csrf_field()); ?>

                            <input type="text" name="id" hidden class="form-control" placeholder="id"
                                   value="<?php echo e($our_team_roles->id); ?>"/>
                                ...
                                <div class="col-lg-6">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="name" class="form-control" placeholder="Name"
                                               value="<?php echo e($our_team_roles->name); ?>"/>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\onlineShoppingUgur\resources\views/admin/our_team_roles_edit.blade.php ENDPATH**/ ?>