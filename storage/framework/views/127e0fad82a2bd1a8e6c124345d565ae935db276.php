                        ...
                        <form id="myForm" class="form-horizontal form-bordered" method="post"
                                ...
                                <div class="col-lg-6">
                                    <div class="input-group">
                                        <input hidden type="text" name="last_loqo" class="form-control"
                                               value="<?php echo e(base64_encode($categoryes->logo)); ?>"/>
                                        <img style='display:block;width:80px;height:60px;'
                                             src="data:image/jpeg;base64,<?php echo e(base64_encode($categoryes->logo)); ?>"/>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="name" class="form-control" placeholder="Name"
                                               value="<?php echo e($categoryes->name); ?>"/>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="input-group">
                                        ...
                                        <select name="status" data-plugin-selectTwo class="form-control populate">
                                            <option value="1" <?php if( $categoryes->status==1): ?> selected <?php endif; ?>>Aktiv</option>
                                            <option value="0" <?php if( $categoryes->status==0): ?> selected <?php endif; ?>>Deaktiv</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="compose pt-3">
                                ...
                                <div class="text-right mt-3">
                                    <a href="<?php echo e(url('admin/categoryes')); ?>" class="btn btn-info">
            ...
            $('#myForm').ajaxForm({
                ...
                success: function (response) {
                    ...
                    if(response.status=='success'){
                        window.location.href='/admin/categoryes';
                    }
                }
            });
        });
...
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\onlineShoppingUgur\resources\views/admin/categoryes_edit.blade.php ENDPATH**/ ?>