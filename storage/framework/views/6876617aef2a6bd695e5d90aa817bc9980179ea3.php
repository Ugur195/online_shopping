                    ...
                    <div class="card-body">
                            ...
                            <div class="col-lg-6">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="full_name" class="form-control" placeholder="Full Name"
                                           readonly="readonly"
                                           value="<?php echo e($comment->full_name); ?>"/>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-6">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="email" class="form-control" placeholder="Email"
                                           readonly="readonly"
                                           value="<?php echo e($comment->email); ?>"/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <textarea class="form-control" rows="3" id="textareaAutosize" name="texts"
                                          ...
                                          readonly="readonly"><?php echo e($comment->texts); ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="compose pt-3">
                            ...
                            <div class="text-right mt-3">
                                <a href="<?php echo e(url('admin/comments/')); ?>" class="btn btn-info">
                                    <i class="fas fa-arrow-left"></i>
                                    Back
                                </a>

                                <button
                                    onclick="publish('<?php echo e($comment->email); ?>', '<?php echo e($comment->full_name); ?>', <?php echo e($comment->id); ?>)"
                                    class="btn btn-success" name="btn_publish" value="btn_publish">
                                    <i class="fa fa-upload"></i>
                                    Publish
                                </button>

                                <button onclick="sil(this,<?php echo e($comment->id); ?>)" class="btn btn-danger"
                                        name="btn_delete"
                                        value="btn_delete">
...
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\onlineShoppingUgur\resources\views/admin/comment.blade.php ENDPATH**/ ?>