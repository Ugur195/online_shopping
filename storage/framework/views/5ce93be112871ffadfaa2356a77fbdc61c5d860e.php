            ...
            <section class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="mb-3">
                                <a href="<?php echo e(url('admin/add_menu')); ?>"  class="btn btn-success">Add <i class="fas fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                    <table class="table table-bordered table-striped mb-0" id="datatable-editable">
                        ...
                        <?php $__currentLoopData = $menu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr data-item-id="1">
                                <td hidden><input name="msg_id value="><?php echo e($m->id); ?>"</td>
                                <td><?php echo e($m->id); ?></td>
                                <td><?php echo e($m->name); ?></td>
                                <td><?php echo e($m->slug); ?></td>
                                <td><?php echo e($m->page); ?></td>
                                <td>
                                    <?php if($m->status==1): ?>
                                        Aktiv
                                    <?php else: ?>
                                ...
                                <td class="actions">
                                    <a href="<?php echo e(url('admin/menu_edit/'.$m->id)); ?>" class="btn btn-success" style="color: white"><i
                                            class="fas fa-pencil-alt"></i></a>
                                    <button onclick="sil(this, <?php echo e($m->id); ?>)" type="button" class="btn btn-danger"><i
...
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\onlineShoppingUgur\resources\views/admin/menu.blade.php ENDPATH**/ ?>