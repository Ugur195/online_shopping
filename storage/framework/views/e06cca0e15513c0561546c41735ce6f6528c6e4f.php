                                    ...
                                    <div class="input-group">
                                        ...
                                        <select name="user_id" id="user_id" data-plugin-selectTwo
                                            ...
                                            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($u->id); ?>"><?php echo e($u->name); ?> <?php echo e($u->surname); ?> <?php echo e($u->father_name); ?></option>
                                ...
                                <div class="col-lg-6">
                                    <div class="input-group">
                                        ...
                                        <select name="roles_id" id="roles_id" data-plugin-selectTwo
                                            ...
                                            <?php $__currentLoopData = $our_team_rules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $otr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($otr->id); ?>"><?php echo e($otr->name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                </div>
...
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\onlineShoppingUgur\resources\views/admin/add_our_team.blade.php ENDPATH**/ ?>