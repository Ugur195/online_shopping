        ...
        <div class="row">
            <div class="col">
                <section class="card">
                    ...
                    <div class="card-body">
                        <form class="form-horizontal form-bordered" method="post" action="<?php echo e(url('/admin/blog_category_edit/ $blog_category->id')); ?>">
                                ...
                                <div class="col-lg-6">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="name" class="form-control" placeholder="Name"
                                               value="<?php echo e($blog_category->name); ?>"/>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="input-group">
                                        ...
                                        <select name="status" data-plugin-selectTwo class="form-control populate">
                                            <option value="1" <?php if($blog_category->status==1): ?> selected <?php endif; ?>>Aktiv</option>
                                            <option value="0" <?php if($blog_category->status==0): ?> selected <?php endif; ?>>Deaktiv</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="compose pt-3">
                                ...
                                <div class="text-right mt-3">
                                    <a href="<?php echo e(url('admin/blog_category')); ?>" class="btn btn-info">
...
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\onlineShoppingUgur\resources\views/admin/blog_category_edit.blade.php ENDPATH**/ ?>