            ...
            <section class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="mb-3">
                                <a href="<?php echo e(url('admin/add_categoryes')); ?>"  class="btn btn-success">Add <i class="fas fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                    <table class="table table-bordered table-striped mb-0" id="datatable-editable">
                        ...
                        <?php $__currentLoopData = $categoryes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr data-item-id="1">
                                <td hidden><input name="msg_id value="><?php echo e($c->id); ?>"</td>
                                <td><img style='display:block;width:80px;height:60px;'src="data:image/jpeg;base64,<?php echo e(base64_encode($c->logo)); ?>"/></td>
                                ...
                                <td class="actions">
                                    <a href="<?php echo e(url('admin/categoryes_edit/'.$c->id)); ?>" class="btn btn-success" style="color: white"><i
                                            class="fas fa-pencil-alt"></i></a>
                                    <button onclick="sil(this, <?php echo e($c->id); ?>)" type="button" class="btn btn-danger"><i
...
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\onlineShoppingUgur\resources\views/admin/categoryes.blade.php ENDPATH**/ ?>