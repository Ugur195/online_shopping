            ...
            <section class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="mb-3">
                                <a href="<?php echo e(url('admin/add_blogs')); ?>" class="btn btn-success">Add <i
                    ...
                    <table class="table table-bordered table-striped mb-0" id="datatable-editable">
                        ...
                        <?php $__currentLoopData = $blogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr data-item-id="1">
                                <td><img style='display:block;width:80px;height:60px;'src="data:image/jpeg;base64,<?php echo e(base64_encode($b->images)); ?>"/></td>
                                <td><?php echo e($b->id); ?></td>
                                <td><?php echo e($b->header); ?></td>
                                <td><?php echo e($b->description); ?></td>
                                <td><?php echo e($user->name); ?> <?php echo e($user->surname); ?></td>
                                <td><?php echo e(\App\BlogCategory::find($b->category_id)->name); ?></td>
                                <td>
                                    <?php if($b->status==1): ?>
                                        Aktiv
                                    <?php else: ?>
                                ...
                                <td class="actions">
                                    <a href="<?php echo e(url('admin/blogs_edit/'.$b->id)); ?>" class="btn btn-success"
                                       style="color: white"><i
...
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\onlineShoppingUgur\resources\views/admin/blogs.blade.php ENDPATH**/ ?>