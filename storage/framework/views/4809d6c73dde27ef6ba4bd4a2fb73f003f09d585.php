            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 align-self-center p-static order-2 text-center">
                        <h1><strong>Categoryes</strong></h1>
                    </div>
                </div>
            </div>
        </section>
									...
									<a href="shop-cart.html" class="add-to-cart-product bg-color-primary">
										...
										<span class="product-thumb-info-image">
											<img alt="" class="img-fluid"
                                                 src="data:image/jpeg;base64,<?php echo e(base64_encode($c->logo)); ?>">
										</span>
									<span
                                        class="product-thumb-info-content product-thumb-info-content pl-0 bg-color-light">
                                         <a href="<?php echo e(url('categoryes_products/'.$c->id)); ?>">
                                <span class="amount text-blue font-weight-semibold"><?php echo e($c->name); ?></span>
                            </a>
									</span>
								</span>
                        </div>
...
<?php echo $__env->make('frontend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\onlineShoppingUgur\resources\views/frontend/categoryes.blade.php ENDPATH**/ ?>