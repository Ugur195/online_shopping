    ...
    <section class="body">
        <section role="main" class="content-body">
            ...
            <form id="myForm" class="form-horizontal form-bordered" method="post"
                  action="<?php echo e(url('admin/monthly_report')); ?>"
...
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\onlineShoppingUgur\resources\views/admin/monthly_report.blade.php ENDPATH**/ ?>