                ...
                <div class="card-body">
                    <table class="table table-bordered table-striped mb-0" id="datatable-editable">
                        ...
                        @foreach($blogs_comments as $bc)
                            <tr data-item-id="1">
                                <td hidden><input name="msg_id value=">{{$bc->id}}"</td>
                                <td>{{$bc->id}}</td>
                                <td>{{$bc->full_name}}</td>
                                <td>{{$bc->email}}</td>
                                <td>{{$bc->texts}}</td>
                                <td>{{\App\Blogs::find($bc->blog_id)->header}}</td>
                                <td>{{$bc->parent_id}}</td>
                                <td>
                                    @if($bc->status==1)
                                        Aktiv
                                ...
                                <td class="actions">
                                    <button onclick="publish('{{$bc->email}}', '{{$bc->full_name}}', {{$bc->id}})" class="btn btn-success"
                                            style="color: white"><i class="fas fa-check"></i></button>
                                    <button onclick="sil(this, {{$bc->id}})" type="button" class="btn btn-danger"><i
                                            class="fas fa-trash "></i></button>
                                    <a href="{{url('admin/blogs_comments_edit/'.$bc->id)}}" class="btn btn-info"
