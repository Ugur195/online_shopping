                ...
                <section class="card">
                    ...
                    <div class="card-body">
                        <form id="myForm" class="form-horizontal form-bordered" method="post"
                              action="{{url('/admin/categoryes_edit/'.$categoryes->id)}}">
                            {{csrf_field()}}
                                ...
                                <div class="col-lg-6">
                                    <div class="input-group">
                                        <input hidden type="text" name="last_loqo" class="form-control"
                                               value="{{base64_encode($categoryes->logo)}}"/>
                                        <img style='display:block;width:80px;height:60px;'
                                             src="data:image/jpeg;base64,{{base64_encode($categoryes->logo)}}"/>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="input-group">
                                        ...
                                        <select name="status" data-plugin-selectTwo class="form-control populate">
                                            <option value="1" @if( $categoryes->status==1) selected @endif>Aktiv</option>
                                            <option value="0" @if( $categoryes->status==0) selected @endif>Deaktiv</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="compose pt-3">
                                ...
                                <div class="text-right mt-3">
                                    <a href="{{url('admin/categoryes')}}" class="btn btn-info">
