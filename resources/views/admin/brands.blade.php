            ...
            <section class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="mb-3">
                                <a href="{{url('admin/add_brand')}}"  class="btn btn-success">Add <i class="fas fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                    <table class="table table-bordered table-striped mb-0" id="datatable-editable">
                        ...
                        @foreach($brands as $b)
                            <tr data-item-id="1">
                                <td hidden><input name="msg_id value=">{{$b->id}}"</td>
                                <td><img style='display:block;width:80px;height:60px;'src="data:image/jpeg;base64,{{base64_encode($b->logo)}}"/></td>
                                <td>{{$b->id}}</td>
                                <td>{{$b->name}}</td>
                                <td>{{$b->slug}}</td>
                                <td>
                                ...
                                <td class="actions">
                                    <a href="{{url('admin/brand_edit/'.$b->id)}}" class="btn btn-success" style="color: white"><i
