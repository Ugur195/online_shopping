                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <textarea class="form-control" rows="3" id="textareaAutosize" name="texts"
                                          ...
                                          readonly="readonly">{{$comment->texts}}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="compose pt-3">
                            ...
                            <div class="text-right mt-3">
                                <a href="{{url('admin/comments/')}}" class="btn btn-info">
                                    <i class="fas fa-arrow-left"></i>
                                    Back
                                </a>

                                <button
                                    onclick="publish('{{$comment->email}}', '{{$comment->full_name}}', {{$comment->id}})"
                                    class="btn btn-success" name="btn_publish" value="btn_publish">
                                    <i class="fa fa-upload"></i>
                                    Publish
                                </button>

                                <button onclick="sil(this,{{$comment->id}})" class="btn btn-danger"
                                        name="btn_delete"
                                        value="btn_delete">
