            ...
            <section class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="mb-3">
                                <a href="{{url('admin/add_menu')}}"  class="btn btn-success">Add <i class="fas fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                    <table class="table table-bordered table-striped mb-0" id="datatable-editable">
                        ...
                        @foreach($menu as $m)
                            <tr data-item-id="1">
                                <td hidden><input name="msg_id value=">{{$m->id}}"</td>
                                <td>{{$m->id}}</td>
                                <td>{{$m->name}}</td>
                                <td>{{$m->slug}}</td>
                                <td>{{$m->page}}</td>
                                ...
                                <td class="actions">
                                    <a href="{{url('admin/menu_edit/'.$m->id)}}" class="btn btn-success" style="color: white"><i
                                            class="fas fa-pencil-alt"></i></a>
                                    <button onclick="sil(this, {{$m->id}})" type="button" class="btn btn-danger"><i
