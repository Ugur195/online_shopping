            ...
            <section class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="mb-3">
                                <a href="{{url('admin/add_slideshow')}}"  class="btn btn-success">Add <i class="fas fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                    <table class="table table-bordered table-striped mb-0" id="datatable-editable">
                        ...
                        @foreach($slideshows as $s)
                            <tr data-item-id="1">
                                <td hidden><input name="msg_id value=">{{$s->id}}"</td>
                                <td><img style='display:block;width:80px;height:60px;'src="data:image/jpeg;base64,{{base64_encode($s->image)}}"/></td>
                                <td>{{$s->id}}</td>
                                <td>{{$s->title}}</td>
                                <td>{{$s->url}}</td>
                                <td>{{$s->description}}</td>
                                ...
                                <td class="actions">
                                    <a href="{{url('admin/slideshow_edit/'.$s->id)}}" class="btn btn-success" style="color: white"><i
                                            class="fas fa-pencil-alt"></i></a>
                                    <button onclick="sil(this, {{$s->id}})" type="button" class="btn btn-danger"><i
