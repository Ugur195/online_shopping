                ...
                <div class="card-body">
                    <table class="table table-bordered table-striped mb-0" id="datatable-editable">
                        ...
                        @foreach($messages as $msg)
                            <tr data-item-id="1">
                                <td hidden><input name="msg_id value=">{{$msg->id}}"</td>
                                <td>{{$msg->id}}</td>
                                <td>{{$msg->full_name}}</td>
                                <td>{{$msg->subject}}</td>
                                <td>{{$msg->email}}</td>
                                ...
                                <td class="actions">
                                    <a href="{{url('admin/messages/'.$msg->id)}}" class="btn btn-success"
                                       style="color: white"><i
                                            class="fas fa-reply"></i></a>
                                    <button onclick="sil(this, {{$msg->id}})" type="button" class="btn btn-danger"><i
