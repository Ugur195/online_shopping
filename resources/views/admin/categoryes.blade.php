            ...
            <section class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="mb-3">
                                <a href="{{url('admin/add_categoryes')}}"  class="btn btn-success">Add <i class="fas fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                    <table class="table table-bordered table-striped mb-0" id="datatable-editable">
                        ...
                        @foreach($categoryes as $c)
                            <tr data-item-id="1">
                                <td hidden><input name="msg_id value=">{{$c->id}}"</td>
                                <td><img style='display:block;width:80px;height:60px;'src="data:image/jpeg;base64,{{base64_encode($c->logo)}}"/></td>
                                <td>{{$c->id}}</td>
                                <td>{{$c->name}}</td>
                                <td>{{$c->slug}}</td>
                                <td>
                                ...
                                <td class="actions">
                                    <a href="{{url('admin/categoryes_edit/'.$c->id)}}" class="btn btn-success" style="color: white"><i
                                            class="fas fa-pencil-alt"></i></a>
                                    <button onclick="sil(this, {{$c->id}})" type="button" class="btn btn-danger"><i
