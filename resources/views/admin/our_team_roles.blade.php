            ...
            <section class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="mb-3">
                                <a href="{{url('admin/add_our_team_roles')}}"  class="btn btn-success">Add <i class="fas fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                    <table class="table table-bordered table-striped mb-0" id="datatable-editable">
                        ...
                        <tbody>
                        @foreach($our_team_roles as $ot)
                            <tr  data-item-id="1">
                                <td>{{$ot->name}}</td>
                                <td>{{$ot->created_at}}</td>
                                <td>{{$ot->updated_at}}</td>
                                <td >
                                    <a href="{{url('admin/our_team_roles_edit/'.$ot->id)}}" class="btn btn-success" style="color: white"><i
                                            class="fas fa-pencil-alt"></i></a>
                                    <button onclick="sil(this, {{$ot->id}})" type="button" class="btn btn-danger"><i
