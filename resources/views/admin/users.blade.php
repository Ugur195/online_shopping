            ...
            <section class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="mb-3">
                                <a href="{{url('admin/add_users')}}"  class="btn btn-success">Add <i class="fas fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                    <table class="table table-bordered table-striped mb-0" id="datatable-editable">
                        ...
                        @foreach($users as $u)
                            <tr data-item-id="1">
                                <td><img style='display:block;width:80px;height:60px;'src="data:image/jpeg;base64,{{base64_encode($u->image)}}"/></td>
                                <td>{{$u->id}}</td>
                                <td>{{$u->name}}</td>
                                <td>{{$u->surname}}</td>
                                <td>{{$u->father_name}}</td>
                                ...
                                <td>{{$u->email}}</td>
                                <td>{{$u->address}}</td>
                                <td>{{\App\Roles::find($u->role_id)->name}}</td>
                                <td>
                                    @if($u->status==1)
                                        Aktiv
                                    @else
                                ...
                                <td class="actions">
                                    <a href="{{url('admin/user_edit/'.$u->id)}}" class="btn btn-success" style="color: white"><i
                                            class="fas fa-pencil-alt"></i></a>
                                    <button onclick="sil(this, {{$u->id}})" type="button" class="btn btn-danger"><i
