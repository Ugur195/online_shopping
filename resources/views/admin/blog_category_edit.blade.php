        ...
        <div class="row">
            <div class="col">
                <section class="card">
                    ...
                    <div class="card-body">
                        <form class="form-horizontal form-bordered" method="post" action="{{url('/admin/blog_category_edit/ $blog_category->id')}}">
                            {{csrf_field()}}
                                ...
                                <div class="col-lg-6">
                                    <div class="input-group">
                                        ...
                                        <select name="status" data-plugin-selectTwo class="form-control populate">
                                            <option value="1" @if($blog_category->status==1) selected @endif>Aktiv</option>
                                            <option value="0" @if($blog_category->status==0) selected @endif>Deaktiv</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="compose pt-3">
                                ...
                                <div class="text-right mt-3">
                                    <a href="{{url('admin/blog_category')}}" class="btn btn-info">
