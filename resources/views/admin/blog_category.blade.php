            ...
            <section class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="mb-3">
                                <a href="{{url('admin/add_blog_category')}}"  class="btn btn-success">Add <i class="fas fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                    <table class="table table-bordered table-striped mb-0" id="datatable-editable">
                        ...
                        @foreach($blog_category as $bc)
                            <tr data-item-id="1">
                                ...
                                <td class="actions">
                                    <a href="{{url('admin/blog_category_edit/'.$bc->id)}}" class="btn btn-success" style="color: white"><i
