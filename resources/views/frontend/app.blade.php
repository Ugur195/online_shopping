...
<head>
    ...
    <!-- Vendor CSS -->
    <link rel="stylesheet" href="{{asset('frontendCss/vendor/bootstrap/css/bootstrap.min.css')}}">
    <link rel="stylesheet" href="{{asset('frontendCss/vendor/fontawesome-free/css/all.min.css')}}">
    <link rel="stylesheet" href="{{asset('frontendCss/vendor/animate/animate.min.css')}}">
    <link rel="stylesheet" href="{{asset('frontendCss/vendor/simple-line-icons/css/simple-line-icons.min.css')}}">
    <link rel="stylesheet" href="{{asset('frontendCss/vendor/owl.carousel/assets/owl.carousel.min.css')}}">
    <link rel="stylesheet" href="{{asset('frontendCss/vendor/owl.carousel/assets/owl.theme.default.min.css')}}">
    <link rel="stylesheet" href="{{asset('frontendCss/vendor/magnific-popup/magnific-popup.min.css')}}">

    <!-- Theme CSS -->
    <link rel="stylesheet" href="{{asset('frontendCss/css/theme.css')}}">
    <link rel="stylesheet" href="{{asset('frontendCss/css/theme-elements.css')}}">
    <link rel="stylesheet" href="{{asset('frontendCss/css/theme-blog.css')}}">
    <link rel="stylesheet" href="{{asset('frontendCss/css/theme-shop.css')}}">

    <!-- Current Page CSS -->
    <link rel="stylesheet" href="{{asset('frontendCss/vendor/rs-plugin/css/settings.css')}}">
    <link rel="stylesheet" href="{{asset('frontendCss/vendor/rs-plugin/css/layers.css')}}">
    <link rel="stylesheet" href="{{asset('frontendCss/vendor/rs-plugin/css/navigation.css')}}">

    <!-- Demo CSS -->


    <!-- Skin CSS -->
    <link rel="stylesheet" href="{{asset('frontendCss/css/skins/default.css')}}">

    <!-- Theme Custom CSS -->
    <link rel="stylesheet" href="{{asset('frontendCss/css/custom.css')}}">
@yield('css')

<!-- Head Libs -->
    <script src="{{asset('frontendCss/vendor/modernizr/modernizr.min.js')}}"></script>
                                    ...
                                    <ul class="nav nav-pills">
                                        <li class="nav-item">
                                            <select id="local" name="local" onchange="local()">
                                                <option @if(App::isLocale('az')) selected @endif value="az">Az</option>
                                        ...
                                        <li class="nav-item">
                                            <a href="mailto:mail@domain.com"><i
                                                    ...
                                                    style="top: 1px;"></i> {{$setting->email}}</a>
                                        </li>


                                        <li class="nav-item">
                                            <a href="tel:{{$setting->mobile}}"><i
                                                    class="fab fa-whatsapp text-4 text-color-primary"
                                                    style="top: 0;"></i>{{$setting->mobile}}</a>
                                        </li>
                                        ...
                                        <li class="nav-item dropdown">
                                            @if(Auth::check())
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right"
                                                    ...
                                                    <a class="dropdown-item" href="{{url('my_basket')}}">
                                                        <i style="color: #0aa1e8" class="fa fa-shopping-basket"> My
                                                            Basket </i>
                                                    </a>

                                                    <a class="dropdown-item" href="{{url('purchased_goods')}}">
                                        ...
                                        @else
                                            <li class="nav-item">
                                                <a class="nav-link" href="{{ url('/sign_in') }}">{{ __('Login') }}</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link"
                                                   href="{{ url('/sign_up') }}">{{ __('Register') }}</a>
                                            </li>
                                            @endif
                                            </li>
                                    </ul>
...
<!-- Vendor -->
<script src="{{asset('frontendCss/vendor/jquery/jquery.min.js')}}"></script>
<script src="{{asset('frontendCss/vendor/jquery.appear/jquery.appear.min.js')}}"></script>
<script src="{{asset('frontendCss/vendor/jquery.easing/jquery.easing.min.js')}}"></script>
<script src="{{asset('frontendCss/vendor/jquery.cookie/jquery.cookie.min.js')}}"></script>
<script src="{{asset('frontendCss/vendor/popper/umd/popper.min.js')}}"></script>
<script src="{{asset('frontendCss/vendor/bootstrap/js/bootstrap.min.js')}}"></script>
<script src="{{asset('frontendCss/vendor/bootstrap-star-rating/js/star-rating.min.js')}}"></script>
<script src="{{asset('frontendCss/vendor/bootstrap-star-rating/themes/krajee-fas/theme.min.js')}}"></script>
<script src="{{asset('frontendCss/vendor/common/common.min.js')}}"></script>
<script src="{{asset('frontendCss/vendor/jquery.validation/jquery.validate.min.js')}}"></script>
<script src="{{asset('frontendCss/vendor/jquery.easy-pie-chart/jquery.easypiechart.min.js')}}"></script>
<script src="{{asset('frontendCss/vendor/jquery.gmap/jquery.gmap.min.js')}}"></script>
<script src="{{asset('frontendCss/vendor/jquery.lazyload/jquery.lazyload.min.js')}}"></script>
<script src="{{asset('frontendCss/vendor/isotope/jquery.isotope.min.js')}}"></script>
<script src="{{asset('frontendCss/vendor/owl.carousel/owl.carousel.min.js')}}"></script>
<script src="{{asset('frontendCss/vendor/magnific-popup/jquery.magnific-popup.min.js')}}"></script>
<script src="{{asset('frontendCss/vendor/vide/jquery.vide.min.js')}}"></script>
<script src="{{asset('frontendCss/vendor/vivus/vivus.min.js')}}"></script>

<!-- Theme Base, Components and Settings -->
<script src="{{asset('frontendCss/js/theme.js')}}"></script>

<!-- Current Page Vendor and Views -->
<script src="{{asset('frontendCss/vendor/rs-plugin/js/jquery.themepunch.tools.min.js')}}"></script>
<script src="{{asset('frontendCss/vendor/rs-plugin/js/jquery.themepunch.revolution.min.js')}}"></script>

<!-- Theme Custom -->
<script src="{{asset('frontendCss/js/custom.js')}}"></script>

<!-- Theme Initialization Files -->
<script src="{{asset('frontendCss/js/theme.init.js')}}"></script>

<!-- Examples -->
<script src="{{asset('frontendCss/js/examples/examples.portfolio.js')}}"></script>
