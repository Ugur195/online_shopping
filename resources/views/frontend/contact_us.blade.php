            ...
            <div class="row py-4">
                <div class="col-lg-6">
                    ...
                    <form id="myForm" class="contact-form"
                          action="{{url('/contact_us')}}" method="POST">
                        {{csrf_field()}}
                        ...
                        @else
                            <div class="form-row">
                                <div class="form-group col-lg-6">
                                    <label class="required font-weight-bold text-dark text-2">Full Name</label>
                                    <input readonly type="text" value="{{Auth::user()->name.' '.Auth::user()->surname.' '.Auth::user()->father_name}}" maxlength="100"
                                           class="form-control" name="full_name" id="full_name" required>
                                </div>
                                <div class="form-group col-lg-6">
                                    <label class="required font-weight-bold text-dark text-2">Email Address</label>
                                    <input readonly type="email" value="{{Auth::user()->email}}" maxlength="100" class="form-control" name="email"
                                           id="email" required>
                                </div>
                            </div>
                        @endif
